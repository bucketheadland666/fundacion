        ...
        <div id='content'>
            <div class='panel panel-default'>
                <div class='panel-heading'>
                    ...
                    Administración de las API's del Sistema
                ...
                <div class='panel-body'>
                    ...
                    <div class='row text-rigth'>
                        <div class='col-md-12'>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-large" href="informacion_api.php" style="width: 300px;">
                    ...
                    <div class='row text-rigth'>
                        <div class='col-md-12'>
                            <!-- <input class='knob second' data-bgcolor='#d4ecfd' data-fgcolor='#30a1ec' data-height='140' data-inputcolor='#333' data-thickness='.3' data-width='140' type='text' value='50'> -->
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="btn btn-large success " href="usuarios_api.html" style="width: 300px;">
                    ...
                    <div class='row text-rigth'>
                        <div class='col-md-12'>
                            <!-- <input class='knob second' data-bgcolor='#d4ecfd' data-fgcolor='#30a1ec' data-height='140' data-inputcolor='#333' data-thickness='.3' data-width='140' type='text' value='50'> -->
                            &nbsp;&nbsp;&nbsp;&nbsp; 
                            <a class="btn btn-large " href="medicos_api.html" style="width: 300px;">
