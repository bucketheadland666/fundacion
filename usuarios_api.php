...
<body class='main page' style="background-color: white;   margin:0;
  padding:0">
    ...
    <div id='wrapper' style="margin-top: 20px;">
        ...
        <section id='tools'>
            <ul class='breadcrumb' id='breadcrumb'>
                ...
                <li><a href="#">Apis</a></li>
                <li><a href="#"><u> <i class='material-icons'>description</i> Api Usuarios App</u></a></li>
        ...
        <div id='content'>
            <div class='panel panel-default grid'>
                <div class='panel-heading'>
                    ...
                    Api Usuarios App &nbsp;&nbsp; <button id="btnNuevo" class='btn btn-danger btn-sm'><i
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row text-center">
                                        <div class='col-lg-12' style="justify-content: center;">
                                            ...
                                            <img id="img1" width="100%" alt='logo' />
                                            <br>
                                            <br>
                                            <input type="file">
    ...
    <script type="text/javascript" src="assets/js/usuarios_api.js"></script>
